  ...
  return (
    <div className="mx-[10%]">
      ...
      <div>
        ...
        <button className="text-base tracking-[1px] font-CormorantGaramond bg-dark text-beige dark:bg-beige dark:text-dark py-3 px-6 rounded-full hover:px-[30px] my-7">
